...
class ILUSolver {
  public:
     ...
     */
    virtual bool factorize(const SparseMatrix& matrix) = 0;
     ...
     */
    virtual ComplexVector solve(const ComplexVector& rhs) = 0;
     ...
     */
    virtual bool update_factorization(const SparseMatrix& matrix) = 0;
