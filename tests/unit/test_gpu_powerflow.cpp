...
void test_gpu_powerflow_convergence() {
    ...
    matrix.values = {
        Complex(5.0, -15.0), Complex(-2.0, 6.0), Complex(-1.0, 3.0),
        Complex(-2.0, 6.0), Complex(8.0, -20.0),
        Complex(-3.0, 8.0), Complex(6.0, -18.0), Complex(-1.5, 4.0),
        Complex(-1.5, 4.0), Complex(4.0, -12.0)
    };
...
void test_gpu_powerflow_different_configs() {
    ...
    matrix.values = {
        Complex(10.0, -25.0), Complex(-5.0, 12.5),
        Complex(-5.0, 12.5), Complex(10.0, -25.0)
    };
