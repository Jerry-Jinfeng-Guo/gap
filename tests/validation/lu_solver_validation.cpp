...
void register_lu_solver_validation_tests(TestRunner& runner) {
    ...
    // runner.add_test("LU Solver GPU vs CPU Performance",
    // test_lu_solver_gpu_vs_cpu_performance); runner.add_test("LU Solver Performance
    // Profiling", test_lu_solver_performance_profiling); runner.add_test("CPU LU vs GPU cuDSS
    // Performance", test_cpu_lu_vs_gpu_qr_performance);
}